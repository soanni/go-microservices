...
func (*Consignment) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_2724f600a7578692, []int{0}
}
...
func (*Container) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_2724f600a7578692, []int{1}
}
...
func (*GetRequest) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_2724f600a7578692, []int{2}
}
...
func (*Response) Descriptor() ([]byte, []int) {
	return fileDescriptor_consignment_2724f600a7578692, []int{3}
}
...
func init() {
	proto.RegisterFile("proto/consignment/consignment.proto", fileDescriptor_consignment_2724f600a7578692)
}

var fileDescriptor_consignment_2724f600a7578692 = []byte{
